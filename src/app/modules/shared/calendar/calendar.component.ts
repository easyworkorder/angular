                ...
                <div class="calendar-wrapper">
                   ...
                   <!--<button type="button" [icon]="icon" pButton *ngIf="showIcon" (click)="onButtonClick($event,inputfield)"
                    [ngClass]="{'ui-datepicker-trigger':true,'ui-state-disabled':disabled}" [disabled]="disabled"></button>-->
                     <!-- <button type="button" *ngIf="showIcon"  [icon]="icon" pButton (click)="onButtonClick($event,inputfield)"
                    [ngClass]="{'ui-datepicker-trigger':true,'ui-state-disabled':disabled}" [disabled]="disabled"></button>-->
                    <!--<span [ngClass]="{'ui-datepicker-trigger':true,'ui-state-disabled':disabled}" (click)="onButtonClick($event,inputfield)" style="cursor:pointer;"><i class="fa fa-calendar fa-lg" aria-hidden="true" ></i></span>-->
                    <span [ngClass]="{'ui-datepicker-trigger':true,'ui-state-disabled':disabled}" class="input-group-addon" (click)="onButtonClick($event,inputfield)" style="cursor:pointer;"><i class="fa fa-calendar fa-lg" aria-hidden="true" ></i></span>
                </div>
            </template>
